...
class RangeGenerator:
	...
	def set_board(self, board):
		...
		ehs_list = self.ehs.get_possible_hand_ehs(board_cards=board, rd=rd)
		self.range_mask = [0 if ehs == -1 else 1 for ehs in ehs_list]
		...
		ehs_structure = list(zip(ehs_list, range(len(ehs_list))))
